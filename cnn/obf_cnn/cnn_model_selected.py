...
def test(params, model, X_test, y_test, NUM_CLASS, path, method, r, eps_heavy,eps_light):
    ...
    modelname = method + '_' + r+'_'+eps_heavy + '_' + eps_light +  \
        '_cnn_video_kb_bin_' + str(path) + '_' + str(acc) + '.h5'
    model.save('/home/haipeng/Documents/models/video/KB/obs_selected/'+modelname)
