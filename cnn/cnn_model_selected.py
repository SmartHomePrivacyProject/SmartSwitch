...
LOG = logging.getLogger('cnn_video')
...
def test(params, model, X_test, y_test, NUM_CLASS,path, method, datadim):
    ...
    modelname = method + '_' + str(datadim) + '_cnn_video_kb_bin_' + str(path) + '_' + str(acc)+ '.h5'
    model.save('/home/haipeng/Documents/models/video/KB/selected/'+modelname)
...
def main():
    try:
        ...
        method = sys.argv[1]
        path = sys.argv[2]
        s_path = '/home/haipeng/Documents/dataset/selected/fs/40%_' + method + '_video_bin_kb_'+path+'.csv'
       ...
       # cols = [i for i in range(500,3000)]
        ...
        X_train, y_train, X_test, y_test, num_classes = su.load_sel_data('/home/haipeng/Documents/dataset/Video_dataset/KB/video_bin_'+path+'_kb.csv', selected_col)
        ...
        test(PARAMS, m, X_test, y_test, num_classes, path, method, PARAMS['data_dim'])
